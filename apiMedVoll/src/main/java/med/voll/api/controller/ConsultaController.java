...
import med.voll.api.consulta.DadosDetalhamentoCancelar;
...
public class ConsultaController {
	...
	@DeleteMapping()
	@Transactional
	public ResponseEntity<DadosDetalhamentoCancelar> cancelar(@RequestBody @Valid DadosCancelamentoConsulta dados) {
